...
export function obtenirTraduccioIdioma(idioma='ca', clau=null) {
    ...
    const traduccions = {
        'ca': {
            ...
            'premut_donar_ordre': 'premut per donar una ordre',
            'imatge_baixada_ok': 'Imatge descarregada correctament',
            'imatge_baixada_ko': 'Hi ha hagut un error en descarregar la imatge',
            'avis_ordre_no_reconeguda': 'Ordre no reconeguda.',
            'avis_error_ordre': "Error en processar l'ordre: ",
        },
        'en': {
            ...
            'avis_veu_baixa': 'El volum de la veu del micròfon és baix o no hi ha cap veu audible.',
...
export function mostrarMissatgeFlotant(missatge, tipus = 'exit', durada = 3000) {
